...
## How to submit a new post easily

*This information will generally be for group members only.*
...
6. now Open a pull request.

Some day we might make it easier using issues and a bot, but no promises we take.
